...
import com.shivam.learn.practiceQuestion.chess.pieces.*;
...
public class Board {
    ...
    public boolean isValidMove(Piece piece, int destRow, int destCol){
        if(piece == null || destCol > 7 || destRow > 7){
            return false;
        }
    ...
    public boolean isCheckmate(Color color) {
        ...
        // Get all the oppnent pieces and check if that piece check in king move if true then return true
        return false;
    }
